...
namespace Unity.FPS.Game
{
    public class GameFlowManager : MonoBehaviour
    {
        ...
        private Agent agent;  // TODO: this is temp for now until we get multiple agents in scene!
        public bool AgentTraining;
        ...
        void Start()
        {
            ...
            Debug.AssertFormat(agent, "GameFlowManager: Could not find any agent!");
        }
