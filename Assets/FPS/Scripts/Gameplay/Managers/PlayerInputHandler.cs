...
namespace Unity.FPS.Gameplay
{
    public class PlayerInputHandler : MonoBehaviour
    {
        ...
        {
            float inputvalue = GetMouseOrStickLookAxis(GameConstants.k_MouseAxisNameHorizontal, GameConstants.k_AxisNameJoystickLookHorizontal);
            if (InvertYAxis) inputvalue *= -1.0f;
            return inputvalue;
        }

        public float GetLookInputsVertical()
        {
            float inputvalue = GetMouseOrStickLookAxis(GameConstants.k_MouseAxisNameVertical, GameConstants.k_AxisNameJoystickLookVertical);
            if (InvertXAxis) inputvalue *= -1.0f;
            return inputvalue;
        }
