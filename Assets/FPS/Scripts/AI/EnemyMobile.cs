...
namespace Unity.FPS.AI
{
    ...
    public class EnemyMobile : MonoBehaviour
    {
        ...
        private bool agentTrainingMode = false;
        ...
        void Start()
        {
			...
			if (GameObject.FindGameObjectWithTag("TrainingManager")) agentTrainingMode = true;
			// in training mode, cancel all sound fx and particle effects to avoid using resources during training
            if (!agentTrainingMode) m_AudioSource.Play();
        }
